...
| Ветка | `main` |
| Рабочее дерево | Starlight adaptation: Gate 3 (deployment base + link contract + Pages workflow) выполнен 2026-09-25; sidebar IA — следующий gate; live deployment ждёт commit/push владельца + успешного Actions run |
