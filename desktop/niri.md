Раздел Desktop Environment — это то, где «чистый Wayland» проявляет себя во всей красе. Мы строим окружение вокруг Niri, инновационного тайлового композитора со скроллингом, и полностью отказываемся от наследия X11.
Начнем с фундаментального конфига самого Niri и настройки порталов, без которых современный Wayland-десктоп не будет функциональным.
## 📄 Наполнение: desktop/niri-compositor.ru.md
