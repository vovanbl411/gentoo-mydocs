...
Practical documentation on setting up and running Gentoo Linux: systemd
and the hardened profile, an LLVM toolchain, Pure Wayland on Niri,
...
in [the GitHub repository](https://github.com/vovanbl411/gentoo-mydocs).
